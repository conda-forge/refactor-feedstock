...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/refactor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13716&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/refactor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `refactor` can be installed with:

```
conda install refactor
```

It is possible to list all of the versions of `refactor` available on your platform with:
